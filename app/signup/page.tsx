      ...
      <div className="w-full max-w-md">
        ...
        <div className="card">
          ...
          <a
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-[var(--color-line)] bg-[var(--color-canvas)] px-4 py-3 text-sm font-medium text-[var(--color-ink)] transition-all hover:border-[var(--color-accent)] hover:shadow-md mb-6"
          >
